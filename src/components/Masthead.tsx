        ...
        <div className="flex items-center justify-between px-4 sm:px-6 h-14">
          ...
          {variant === "newsroom" ? (
            <nav className="hidden md:flex items-center gap-6 text-[13px]">
              ...
              <NavLink to="/style-guide" className={({ isActive }) => isActive ? "text-accent" : "text-primary-foreground/80 hover:text-primary-foreground"}>Style guide</NavLink>
              {isEditor && (
              ...
              {isEditor && (
                <NavLink to="/newsroom/discovery" className={({ isActive }) => isActive ? "text-accent" : "text-primary-foreground/80 hover:text-primary-foreground"}>Discovery</NavLink>
              )}
              {isAdmin && (
